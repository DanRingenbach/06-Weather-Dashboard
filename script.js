...
$(document).ready(function pageLoad() {
  ...
  var lastSearch = (localStorage.getItem("city"));
  var searchDiv = $("<button id='previous-search class='btn border text-muted mt-1 shadow-sm bg-white rounded' style='width: 12rem;'>").text(lastSearch);
  var psearch = $("<div>");
  psearch.append(searchDiv)
  $("#search-nav").append(psearch);

});

$('#select-city').click(function weatherCall(event) {
